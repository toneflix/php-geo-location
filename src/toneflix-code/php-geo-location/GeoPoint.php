...
use ToneflixCode\PhpGeoLocation\Base\GeoLocation;
use ToneflixCode\PhpGeoLocation\Exceptions\NoApiKeyException;
use ToneflixCode\PhpGeoLocation\Exceptions\OutOfBoundsException;
use ToneflixCode\PhpGeoLocation\Exceptions\UnexpectedResponseException;
...
class GeoPoint
{
     ...
     *
     * @param  \ToneflixCode\PhpGeoLocation\GeoLocation  $location
    ...
    {
        if (
            $this->radLat < Earth::getMINLAT() || $this->radLat > Earth::getMAXLAT() ||
     ...
     *          if Google sends us something that we don't expect,
     *          we only like nice presents not 500 errors and the like.
     * @throws NoApiKeyException
     *          if you forget to pass a google API key.
     *          create one at https://console.cloud.google.com for Geocoding API
     */
